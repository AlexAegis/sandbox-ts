...
isExpiredSwitchMap$.subscribe((n) => console.log('switchMap', n));
isExpiredMergeMap$.subscribe((n) => console.log('mergeMap', n));
isExpiredExhaustMap$.subscribe((n) => console.log('exhaustMap', n));
isExpiredConcatMap$.subscribe((n) => console.log('concatMap', n));
